...
### 2. Restrictions
Permission is **NOT** granted to any person obtaining a copy of this software and associated documentation files to:
* **Clone or Download:** You may not clone, download, or mirror this repository for the purpose of local use, redistribution, or modification.
* **Sub-license/Sell:** You may not sell, rent, or sub-license any part of this code.
* **Modify:** You may not create derivative works or alter the code for your own projects.
